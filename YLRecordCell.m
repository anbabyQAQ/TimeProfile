...
- (UIButton *)expandBtn
{
    if (!_expandBtn) {
        ...
        [_expandBtn setBackgroundImage:[UIImage imageNamed:@"YLNOExpandIcon"] forState:UIControlStateNormal];
        [_expandBtn setBackgroundImage:[UIImage imageNamed:@"YLExpandIcon"] forState:UIControlStateSelected];
